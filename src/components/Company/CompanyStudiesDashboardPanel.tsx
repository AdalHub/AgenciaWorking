...
export default function CompanyStudiesDashboardPanel({ showPortalBackLink = false }: Props) {
  ...
  useEffect(() => {
    const load = async () => {
      try {
        ...
        setError('No fue posible cargar los estudios de tu empresa.');
        navigate('/');
      } finally {
        setLoading(false);
      }
  ...
  return (
    <main style={{ minHeight: '65vh', paddingTop: 80, paddingBottom: 48 }}>
      <div style={{ maxWidth: 1200, margin: '0 auto', padding: '0 20px' }}>
        ...
        <h1 style={{ margin: '0 0 8px', fontSize: '1.9rem' }}>Estudios Socioeconomicos</h1>
        <p style={{ margin: '0 0 24px', color: '#64748b', lineHeight: 1.6 }}>
          Consulta los estudios activos y concluidos de tu empresa, revisa el avance por folio y descarga los informes finales disponibles.
        </p>
