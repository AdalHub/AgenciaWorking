...
export default function AdminStudiesPage() {
  ...
  // UX: "Estudios completados" should only show studies that were closed/generated by admin.
    ...
    <>
        <div style={{ maxWidth: 1200, width: '100%', boxSizing: 'border-box' }}>
          ...
          <div style={{ display: 'flex', gap: 8, marginBottom: 20 }}>
            ...
            <button style={tabStyle(mainTab === 'ongoing')} onClick={() => setMainTab('ongoing')}>Estudios completados</button>
          </div>
                  ...
                  {loading ? (
                    ...
                    completedStudies.map((s) => (
                      <tr key={s.id} style={{ borderBottom: '1px solid #e5e7eb' }}>
                        ...
                        <td style={{ padding: 12 }}>
                          <button
                            onClick={() => { setDrawerStudyId(s.id); setDrawerStudyName(s.company_name); }}
                            style={{
                              padding: '6px 12px',
                              background: '#f3f4f6',
                              color: '#0f172a',
      ...
      {drawerStudyId !== null && (
        <>
          {/* overlay: allow close by clicking outside */}
          <div
            onClick={() => { setDrawerStudyId(null); setDrawerStudyName(''); }}
            style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.25)', zIndex: 149 }}
          />
          <div style={{ position: 'fixed', top: 0, right: 0, width: 'min(400px, 100vw)', height: '100%', background: '#fff', boxShadow: '-4px 0 20px rgba(0,0,0,0.1)', zIndex: 150, overflow: 'auto', padding: 24 }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 20 }}>
              ...
              <button
                onClick={() => { setDrawerStudyId(null); setDrawerStudyName(''); }}
                style={{ background: 'none', border: 'none', cursor: 'pointer', fontSize: 18, fontWeight: 900, color: '#0f172a' }}
                aria-label="Cerrar PDFs"
              >
                ✕
              </button>
            </div>
