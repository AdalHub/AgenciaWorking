  ...
  return (
    <div style={{ display: 'grid', gap: 22 }}>
      ...
      {requireAddressVerification ? <div style={{ padding: 20, background: '#f8fafc', borderRadius: 12, border: '1px solid #e2e8f0' }}>
        ...
        <p style={{ margin: '18px 0 12px', fontWeight: 600, fontSize: 14 }}>Autorización:</p>
        ...
        <div style={{ display: 'grid', gap: 12, marginBottom: 16 }}>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10 }}>
            <div><label style={{ fontSize: 12, fontWeight: 600 }}>Opción 1 – Fecha *</label><input type="date" disabled={getField(sec, 'dom_visita') === 'no_autorizo'} value={getField(sec, 'dom_visita_op1_fecha')} onChange={(e) => updateField(sec, 'dom_visita_op1_fecha', e.target.value)} style={{ width: '100%', marginTop: 4, padding: 8, borderRadius: 8, border: '1px solid #e2e8f0', background: getField(sec, 'dom_visita') === 'no_autorizo' ? '#e5e7eb' : '#ffffff', color: getField(sec, 'dom_visita') === 'no_autorizo' ? '#64748b' : '#0f172a', cursor: getField(sec, 'dom_visita') === 'no_autorizo' ? 'not-allowed' : 'text' }} /></div>
            <div><label style={{ fontSize: 12, fontWeight: 600 }}>Horario *</label><input type="text" disabled={getField(sec, 'dom_visita') === 'no_autorizo'} placeholder="ej. 10:00–14:00" value={getField(sec, 'dom_visita_op1_hora')} onChange={(e) => updateField(sec, 'dom_visita_op1_hora', e.target.value)} style={{ width: '100%', marginTop: 4, padding: 8, borderRadius: 8, border: '1px solid #e2e8f0', background: getField(sec, 'dom_visita') === 'no_autorizo' ? '#e5e7eb' : '#ffffff', color: getField(sec, 'dom_visita') === 'no_autorizo' ? '#64748b' : '#0f172a', cursor: getField(sec, 'dom_visita') === 'no_autorizo' ? 'not-allowed' : 'text' }} /></div>
          </div>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10 }}>
            <div><label style={{ fontSize: 12, fontWeight: 600 }}>Opción 2 – Fecha *</label><input type="date" disabled={getField(sec, 'dom_visita') === 'no_autorizo'} value={getField(sec, 'dom_visita_op2_fecha')} onChange={(e) => updateField(sec, 'dom_visita_op2_fecha', e.target.value)} style={{ width: '100%', marginTop: 4, padding: 8, borderRadius: 8, border: '1px solid #e2e8f0', background: getField(sec, 'dom_visita') === 'no_autorizo' ? '#e5e7eb' : '#ffffff', color: getField(sec, 'dom_visita') === 'no_autorizo' ? '#64748b' : '#0f172a', cursor: getField(sec, 'dom_visita') === 'no_autorizo' ? 'not-allowed' : 'text' }} /></div>
            <div><label style={{ fontSize: 12, fontWeight: 600 }}>Horario *</label><input type="text" disabled={getField(sec, 'dom_visita') === 'no_autorizo'} placeholder="ej. Sábado mañana" value={getField(sec, 'dom_visita_op2_hora')} onChange={(e) => updateField(sec, 'dom_visita_op2_hora', e.target.value)} style={{ width: '100%', marginTop: 4, padding: 8, borderRadius: 8, border: '1px solid #e2e8f0', background: getField(sec, 'dom_visita') === 'no_autorizo' ? '#e5e7eb' : '#ffffff', color: getField(sec, 'dom_visita') === 'no_autorizo' ? '#64748b' : '#0f172a', cursor: getField(sec, 'dom_visita') === 'no_autorizo' ? 'not-allowed' : 'text' }} /></div>
          </div>
        </div>
        <div style={{ marginBottom: 16 }}>
          <label style={labelStyle}>Referencias o señas del domicilio (calles, puntos de referencia)</label>
          <textarea disabled={getField(sec, 'dom_visita') === 'no_autorizo'} value={getField(sec, 'dom_senas_opcional')} onChange={(e) => updateField(sec, 'dom_senas_opcional', e.target.value)} rows={2} placeholder="Calles, puntos de referencia para ubicar el domicilio" style={{ ...inputStyle, marginTop: 4, background: getField(sec, 'dom_visita') === 'no_autorizo' ? '#e5e7eb' : inputStyle.background, color: getField(sec, 'dom_visita') === 'no_autorizo' ? '#64748b' : inputStyle.color, cursor: getField(sec, 'dom_visita') === 'no_autorizo' ? 'not-allowed' : 'text' }} />
