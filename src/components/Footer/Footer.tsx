    ...
    <Wrapper>
      ...
      <BottomGrid>
        ...
        <SocialSection>
          ...
          <SocialRow>
            <SocialBtn href="https://www.linkedin.com" aria-label="LinkedIn" target="_blank">
              {/* LinkedIn SVG */}
            ...
            <SocialBtn href="https://www.facebook.com" aria-label="Facebook" target="_blank">
              {/* Facebook SVG */}
              <svg viewBox="0 0 24 24" fill="currentColor">
            ...
            <SocialBtn href="https://www.instagram.com" aria-label="Instagram" target="_blank">
              {/* Instagram SVG */}
              <svg viewBox="0 0 24 24" fill="currentColor">
